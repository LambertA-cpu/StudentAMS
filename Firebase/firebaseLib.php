...
require __DIR__ . '/FirebaseInterface.php';
...
class FirebaseLib implements FirebaseInterface
{
    ...
    /**
     * Sets Base URI, ex: https://campuspoints-e80de-default-rtdb.firebaseio.com/
     *
     * @param string $baseURI https://campuspoints-e80de-default-rtdb.firebaseio.com/
     * @return void
     */
